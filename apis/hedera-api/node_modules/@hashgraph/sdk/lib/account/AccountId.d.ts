...
export default class AccountId {
     ...
     * @param {(EvmAddress)=} evmAddress
     */
    constructor(props: number | Long | import("../EntityIdHelper.js").IEntityId, realm?: (number | Long) | undefined, num?: (number | Long) | undefined, aliasKey?: (PublicKey) | undefined, evmAddress?: (EvmAddress) | undefined);
    shard: Long;
    realm: Long;
    num: Long;
