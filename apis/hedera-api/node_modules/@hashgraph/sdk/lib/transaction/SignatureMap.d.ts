...
export default class SignatureMap extends ObjectMap<AccountId, NodeAccountIdSignatureMap> {
     ...
     * @returns {SignatureMap}
     */
    addSignature(nodeId: AccountId, txId: import("./TransactionId.js").default, publicKey: import("../SignerSignature.js").PublicKey, signature: Uint8Array): SignatureMap;
    /**
     * @returns {SignaturePairMap[]}
     */
    getFlatSignatureList(): import("./SignaturePairMap.js").default[];
}
