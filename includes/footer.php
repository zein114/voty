    ...
    <div class="footer-content">
        <div class="footer-left">
            <div class="logo-container">
                <div class="logo-svg">
                    <a href="./"><img src="assets/images/voty.svg" class="brand-icon" alt="Voty" /></a>
                </div>
                <span class="brand-name">Voty</span>
            </div>
            <p class="brand-description"><?php echo t('brand_description', 'Secure Online Voting Platform'); ?></p>
        </div>
